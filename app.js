...
const product_field=()=>{
    ...
    if(product_data){
        product_data.map((item,index)=>{
            ...
            <td class="text-capitalize">${item.price} BDT</td>
            <td class="text-capitalize">${item.quantity}</td>
            <td class="text-capitalize">${item.price*item.quantity} BDT</td>
        ...
        <td colspan="3"></td>
        <td colspan="3" class="text-end text-capitalize"><h5>Final Price : ${total} BDT</h5></td>
        <td class=""></td>
        </tr>
        `
