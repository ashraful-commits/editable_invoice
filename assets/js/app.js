...
const customer_field=()=>{
    ...
    //  get customer field 
    let customer_name = document.getElementById('customer_name').innerHTML = `${customar_data.name}`;
    let customer_adress = document.getElementById('customer_adress').innerHTML=`${customar_data.adress}`;
    let customer_mobile = document.getElementById('customer_mobile').innerHTML=`${customar_data.mobile}`;
    let customer_date = document.getElementById('customer_date').innerHTML = `${customar_data.date}`;
...
const product_field=()=>{
    ...
    if(product_data){
        product_data.map((item,index)=>{
            ...
            <a href="#product_view" data-bs-toggle="modal" index ="${index}" class="btn btn-sm btn-outline-secondary view_product"><i class="fa-solid fa-eye"></i></a>
        ...
        <td colspan="3"></td>
        <td colspan="3" class="text-end"><h5>Final Price : ${total} BDT</h5></td>
        <td class=""></td>
        </tr>
        `
